...
ifeq ($(config),debug)
  ...
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/libkogs.dylib
  OBJDIR = bin/obj/kogs/Debug
  DEFINES += -DNDEBUG
  ...
  LIBS +=
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -m64 -dynamiclib -Wl,-install_name,@rpath/libkogs.dylib
